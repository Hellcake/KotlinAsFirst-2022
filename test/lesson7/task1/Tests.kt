...
между                более               правой               парой               соседних               слов."""
    ...
    fun animals() {
        ...
        assertEquals(
            mutableSetOf("СуперСобаки"),
            animals(
                listOf(
                    "СуперСобаки: собака - 10000",
                    "БыстроИДёшево: кот - 25000, собака - 30000, шиншилла - 5000",
                    "Люкс: кот - 1000000, собака - 1000000, крыса - 1000000, корова - 1000000, бегемот - 1000000",
                ),
                listOf("собака"), 10000
            )
        )
